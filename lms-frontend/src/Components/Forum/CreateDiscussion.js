...
const CreateDiscussion = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setDiscussionData({topic: '', question: '', modulename: ''});
        if (res.status === 200) {
    ...
    return (
        <div className={"container"}>
            <h1 className="display-5 text-center my-5" fw-bold text-white >Create Discussion</h1>
                ...
                <div>
                    <div className="mb-3 col">
                        ...
                        <input
                            ...
                            onChange={(e) => setDiscussionData({...discussionData, topic: e.target.value})}
                        />
                    </div>
                    <div className="mb-3 col">
                        ...
                        <Select
                            ...
                            onChange={(e) => setDiscussionData({...discussionData, modulename: e.value})}
                        />
                    </div>
                    <div className="mb-3 col">
                        ...
                        <input
                            ...
                            onChange={(e) =>setDiscussionData({...discussionData, question: e.target.value})}
                        />
                    </div>                    
